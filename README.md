...
- Description : 아주대학교 학생들을 위한 개발 커뮤니티 플랫폼
    ...
    - 과제/프로젝트 등의 일정을 관리할 수 있는 투두, 플래너
    - 실시간 소통을 위한 메타버스+채팅
- What did I do : 한 거 거의 없음.
    - 프론트 처음 배우기 → 리액트, 상태 관리 등 프론트엔드 지식 학습 및 실습
    - 프로젝트 협업 방식 배우기 → 코드리뷰, 스프린트 설계 및 회고, 깃을 통한 협업, 컨벤션(커밋, 브랜치, PR, 폴더구조 등), 스토리북 툴을 활용한 디자이너와 FE와의 협업
- Tech Stack:
    - Typescript, Next.js, styled-component, recoil
